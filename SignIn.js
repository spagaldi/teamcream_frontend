        ...
        <View style={styles.container}>
            ...
            */}
            ...
            <View>
             ...
             {/* ENTER PASSWORD BOX */}
            <View style={{paddingTop: height*.025, paddingBottom: height*.012}}>
                <TextInput
                style={styles.textInputStyle}
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <View style={{flex: 1, height: height*.003, backgroundColor: 'black', marginLeft: "5%"}}/>
                <View>
                    <Text style={{width: width*.1, textAlign: 'center'}}>OR</Text>
                </View>
                <View style={{flex: 1, height: height*0.003, backgroundColor: 'black', marginRight: "5%"}}/>
            </View>
            ...
            <View style={styles.bottom}>
                <View style={{flexDirection: 'row', paddingBottom: height*.01}}>
